...
export default function Home() {
  ...
  const t: any = {
    english: {
      ...
      assistant_p: "Query live truck routes, warehouse inventory, delivery ETAs, or fertilizer availability",
      ...
      tracker_desc: "AI detects fertilizer shortages at warehouses and dynamically reroutes delivery trucks in real-time to maintain stable supply.",
    ...
    hindi: {
      ...
      assistant_p: "ट्रक का रूट, गोदाम का स्टॉक, डिलीवरी ETA या खाद की उपलब्धता के बारे में पूछें",
      ...
      tracker_desc: "AI गोदामों में खाद की कमी का पता लगाता है और सप्लाई को स्थिर रखने के लिए ट्रकों को तुरंत रीरूट करता है।",
    ...
    hinglish: {
      ...
      assistant_tag: "Supply Chain AI",
      assistant_h2: "Logistics Assistant",
      assistant_p: "Truck routes, warehouse stock, delivery ETA ya fertilizer kab available hoga, ye sab puchiye",
      ...
      tracker_title: "Dynamic Supply Chain Optimization",
      tracker_desc: "AI warehouse pe fertilizer shortage detect karke trucks ko turant reroute karta hai taaki supply hamesha maintain rahe.",
      step1: "Godown Factory",
      step1_sub: "Urea Fertilizer (50kg)",
